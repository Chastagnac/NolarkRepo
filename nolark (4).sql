...
(47, 15, 'coccinelle rouge', 2, 334, 0, 'project-coccinelle-rouge.jpg', 6),
...
INSERT INTO `utilisateur` (`login`, `password`, `niveau`) VALUES
('admin', 'admin', 4),
('modo', 'modo', 3),
('user', 'user', 2),
('test', 'test', 2),
...
--
ALTER TABLE `casque`
  ADD CONSTRAINT `fk_marque` FOREIGN KEY (`marque`) REFERENCES `marque` (`id`),
